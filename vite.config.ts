  ...
  plugins: [
    ...
    VitePWA({ 
      ...
      manifest: {
        short_name: "Rootify",
        name: "Rootify",
        description: "Rootify is a numerical methods tool built using React. It allows users to calculate the roots of a function using two different methods: the bisection method and the Newton-Raphson method.",
        display: "standalone",
        scope: "/",
        start_url: "/",
        icons: [
